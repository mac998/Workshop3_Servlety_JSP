...
<div class="container-fluid">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            <label for="exampleInputName" class="form-label">Nazwa</label>
            <input type="text" class="form-control" id="exampleInputName" name="userName" value="${user.userName}" required>
        </div>
        <div class="mb-3">
